...
public class Rockstar extends ArrayList {
	...
	public void has_left_the_room() {
		System.exit(0);
	}
		
	public void has_left_the_room(String S) {
		if (S.contains("once")){
			System.exit(1);
		}
	...
	//arrays
	//retrieve
	public Rockstar the(float i,String s) {
		return array.get((int)i-1);
	}
    ...
    //comparison Boolean
	public boolean is_scary_like(Rockstar b) {
		
		return (boo == b.said_boo());
	}
	
public boolean isnt_scary_like(Rockstar b) {
